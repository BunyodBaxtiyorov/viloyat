        ...
        <form>
            <div className="searchFormContainer">
                ...
                <div className="searchFormInputContainer">
                    <input onChange={(eo) => {setPickup(eo.target.value)}} style={{marginBottom: '15px'}} type="text" name="pickup" className="input" placeholder="Joylashuvingizni kiriting"/>
                    <input onChange={(eo) => {setDropoff(eo.target.value)}} type="text" name="whereto" className="input" placeholder="Qayerga borasiz ?"/>
                </div>
